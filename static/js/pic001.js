...
//图片按比例缩放
var flag=false;
function DrawImage00(ImgD,iwidth,iheight){
 var image=new Image();
...
function DrawImage123(ImgD,iwidth,iheight){
 var image=new Image();
 var iwidth = 104;  //定义允许图片宽度
...
function DrawImage0003(ImgD,iwidth,iheight){
 var image=new Image();
...
function DrawImage0312(ImgD,iwidth,iheight){
 var image=new Image();
 var iwidth = 660;  //定义允许图片宽度
